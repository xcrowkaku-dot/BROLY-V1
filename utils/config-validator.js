...
function validate(config) {
  ...
  if (process.env.DASHBOARD_API_KEY || process.env.SESSION_SECRET) {
    _set(config, "dashboard.apiKey", process.env.DASHBOARD_API_KEY || process.env.SESSION_SECRET);
  ...
  // Security checks run after environment overrides so valid secret-backed
  // configuration is not reported as insecure.
